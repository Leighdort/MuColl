...
for pid in particle:
    for e in energy: 
        ...
        for a in angles:
            ...
            plt.ylabel("Count")
            plt.xlim(0, 2)
            plt.title(f"Response ({pid}, {a}°, {e} GeV) Baseline-Split")
            plt.legend()
            plt.tight_layout()
            plt.savefig(f"combined_gaussian_{a}_{pid}_{e}_baseline_5000.pdf")
            plt.close()
            ...
            plt.legend()
            plt.title(f"Response ({pid}, {a}°, {e} GeV) Baselinee")
            plt.tight_layout()
            plt.savefig(f"full_gaussian_{a}_{pid}_{e}_baseline_5000.pdf")
            plt.close()

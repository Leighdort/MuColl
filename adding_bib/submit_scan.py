...
# --- Configuration ---
NUM_JOBS_PER_POINT = 1000      # Number of jobs to submit per scan point
NEVENTS_PER_JOB = 10       # Events per job
OUTPUT_BASE_DIR = "/users/rldohert/data/mucoll/rldohert"
#OUTPUT_BASE_DIR = "/users/rldohert/data/mucoll/batch_output"
#OUTPUT_BASE_DIR = "/oscar/data/mleblan6/mucoll/batch_output/rldohert"
...
#Should I still be binding to the above directory?
# --- Scan Parameters ---
# Define the lists of parameters to scan over
PDG_LIST = [211]        # e.g., Electron, Muon, Pion
PT_LIST = [50]         # GeV
THETA_LIST = [(15, 15)] # (Min, Max) degrees
...
for pdg, pt, (theta_min, theta_max) in combinations:
    ...
    config_name = f"pdg_{pdg}_pt_{pt}_theta_{theta_min}-{theta_max}_bib2"
